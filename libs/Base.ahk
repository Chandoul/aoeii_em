...
Class DataMod extends Base {
    ...
    dmPackages => Map(
        ...
        'Elemental TD', Map(
            ...
            'packageName', 'ElementalTD-2.10.7z',
            'packagePath', This.packageLocation '\ElementalTD-2.10.7z',
            'packageVersion', '2.10',
            'packageSizeMB', '65.7',
            'packageLink', 'https://github.com/chandoul/aoeii_em/raw/refs/heads/master/packages/ElementalTD-2.10.7z',
